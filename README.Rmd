...
<font size="5">:bangbang: :warning: **NOTE: This package is currently under active development with a new stable release expected April 30th, 2022. For code written before 2022-03-23, please use the previous stable version (v1.1.0)**:warning::bangbang: </font>
...
- [**Download and gather data from CbioPortal**](https://github.com/karissawhiting/cbioportalR) - Pull from cBioPortal data base by study ID or sample ID. 
...
If you want to oncoKB annotate your data, you need to acquire credentials from the [oncoKB website](https://www.oncokb.org/apiAccess).
...
gt::gtsave(as_gt(gene_tbl_trt),
           file = here::here("man", "figures", "gene_tbl_trt.png"))
```
...
```{r, eval=FALSE, echo=FALSE}
gt::gtsave(as_gt(path_by_trt),
           file = here::here("man", "figures", "path_by_trt.png"))
```
