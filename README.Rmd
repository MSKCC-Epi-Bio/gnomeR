...
<font size="5">:bangbang: :warning: **NOTE: This package is currently under active development with a new stable release expected November 15th, 2022. For code written before 2022-03-23, please use the previous stable version (v1.1.0)**:warning::bangbang: </font>
...
By default, mutations, CNA and fusions will be returned in separate columns. You can combine these at teh gene level using the following:
...
knitr::include_graphics("man/figures/README-tbl_genomic_print-1.png")
...
gt::gtsave(as_gt(path_by_trt), file = file.path(tempdir(), "temp.png"))

```

```{r out.width = "30%", echo = FALSE}

knitr::include_graphics("man/figures/README-tbl_genomic_pathway-1.png")
