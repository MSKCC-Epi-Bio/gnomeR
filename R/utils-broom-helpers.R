...
#
# This file was taken from {gtreg} (thanks @shannonpileggi!)
#
# Notes:
...
.formula_select_error <- function(arg_name) {
  ...
  if (!is.null(arg_name)) {
    ...
    cli::cli_alert_danger("There was a problem with one of the function argument inputs.")
  }
  cli::cli_alert_info("Below is an example of correct syntax.")
  cli::cli_code(example_text)
