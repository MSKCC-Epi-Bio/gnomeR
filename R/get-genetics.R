...
#' @param mutations Boolean specifying if mutation data should be fected. Default is TRUE.
#' @param fusions Boolean specifying if fusion data should be fected. Default is TRUE.
#' @param cna Boolean specifying if cna data should be fected. Default is TRUE.
#'
