...
#### https://github.com/MSKCC-Epi-Bio/gnomeR/issues/176

clin_collab_df_file = here("Data","clin_collab_df.Rdata")
load(clin_collab_df_file)  ### loads in clin_collab_df
...
###Check whether all cbioportal_ids's are actually in cBioPortal
