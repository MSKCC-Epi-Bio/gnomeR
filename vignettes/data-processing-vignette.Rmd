...
As you can see, some variables such as `linkMsa` was not transformed because it is not used in {gnomeR} functions. 
...
add_pathways(gene_binary, pathways = c("Notch", "p53")) %>%
