...
Often a first step to analyzing genomic data is organizing it in an event matrix. This matrix will have one row for each sample in your cohort and one column for each type of genomic event. The `create_gene_binary()` function helps you process your data into this format for use in downstream analysis. 
