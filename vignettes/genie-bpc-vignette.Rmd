...
=======
Next, the fusions file can be transposed to match the expected input for `create_gene_binary()`. See the "Processing data with {gnomeR}" vignette to see more information about how each dataset should be structured.
