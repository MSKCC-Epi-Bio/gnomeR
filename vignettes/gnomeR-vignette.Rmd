...
- specify.plat : boolean specifying if specific IMPACT platforms should be considered. When TRUE NAs will fill the cells for genes of patients that were not sequenced on that plaform
...
The `gen.summary` function allows us to test for potential differences in genetic event frequencies using Fisher's exact test for unpaired data. This function takes the following arguments:
