...
To do this, you need to retrieve the clinical data from cBioPortal using the [cbioportalR package](https://www.karissawhiting.com/cbioportalR/).  
...
Then you will use the `get_clinical_by_sample()` function from the cbioportalR package. Set the `sample_id` parameter to the `cbioportal_ids` from the clinical collaborator's file.  
